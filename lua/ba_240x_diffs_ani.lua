...
function printmessage(seconds)
  local message = string.format("real: %d", rb.HZ )
...
for j=0, 2189, 1 do
	...
	local fullpath = "/bamedia/tiny_240x180-ani/part-" .. string.format("%07d", j)
	...
	-- for i=1, 6572, 1 do
	-- fixme: last file has <200 frames
	for i=1, 3, 1 do
	    	-- local framesz = string.byte(content,counter,counter+4)
		...
		if framesz ~= 4 then
			...
			-- for j=counter, counter + framesz - 4, 3 do
			for j=counter, counter + framesz - 6, 3 do
